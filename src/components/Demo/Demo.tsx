      ...
      >
        <section className="mx-auto w-full px-4 sm:px-6 sm:max-w-150 md:px-8 md:max-w-180 lg:max-w-240 xl:max-w-310 min-h-screen flex flex-col justify-center">
          <div className="relative w-full mx-auto">
            <div
              ref={lineRef5}
              className="absolute top-0 h-[1px] bg-black right-[40px] w-1/2"
            >
              <div
                ref={starRef5}
                className="absolute -top-[20px] left-0 -translate-x-1/2 z-10 opacity-0 scale-0"
              >
                <img
                  src="/svg/ngoi-sao.svg"
                  alt="ngoi-sao"
          ...
          <div ref={bgContentSection5Ref} className="mt-6 h-[80vh] bg-black">
            <div className="flex items-center gap-20 mt-10">
              <div className="flex-1 rotate-45 text-center w-1/4 h-1/4 bg-red-300">
                1
              </div>
              <div className="flex-1 rotate-45 text-center w-1/4 h-1/4 bg-red-300">
                1
